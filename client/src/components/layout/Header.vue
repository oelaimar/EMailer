...
<template>
  <header class="fixed top-0 right-0 left-0 h-16 bg-white border-b border-gray-200 z-30 flex items-center justify-between px-6" :class="appStore.sidebarCollapsed ? 'ml-16' : 'ml-64'">
    <button @click="appStore.toggleSidebar" class="p-2 hover:bg-gray-100 rounded-lg transition-colors">
