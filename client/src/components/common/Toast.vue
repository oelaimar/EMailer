  ...
  <div class="fixed bottom-4 right-4 z-50 flex flex-col gap-2 max-w-sm">
    <TransitionGroup name="toast">
      <div
        ...
        :key="t.id"
        :class="['flex items-center gap-3 px-4 py-3 rounded-lg border shadow-lg', colorMap[t.type] || colorMap.info]"
      >
        ...
        <button @click="toast.removeToast(t.id)" class="ml-2 opacity-60 hover:opacity-100">
