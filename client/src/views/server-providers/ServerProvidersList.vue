...
const actions = [
  { label: 'Edit', class: 'bg-primary-light text-primary hover:bg-blue-200', handler: (row) => router.push(`/server-providers/${row.id}/edit`) },
...
<template>
  <div>
    <PageHeader title="Servers Providers" action-label="Add New Provider" action-to="/server-providers/add" />
