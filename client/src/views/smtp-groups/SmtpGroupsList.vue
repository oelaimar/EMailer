...
const actions = [
  { label: 'Edit', class: 'bg-primary-light text-primary hover:bg-blue-200', handler: (row) => router.push(`/smtp-groups/${row.id}/edit`) },
...
<template>
  <div>
    <PageHeader title="SMTP Groups" action-label="Add New Group" action-to="/smtp-groups/add" />
