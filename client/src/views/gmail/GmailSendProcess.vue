...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <PageHeader title="Gmail Send Process" />
    ...
    <div class="bg-surface rounded-xl border border-border p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div>
          <label class="block text-sm font-medium text-fg-secondary mb-1">ISP Filter</label>
          <select v-model="form.isp" class="w-full px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none">
      ...
      <div class="mb-4">
        ...
        <textarea v-model="form.body" rows="6" class="w-full px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Email body with [placeholders]..."></textarea>
      </div>

      <div class="mb-4">
        <label class="block text-sm font-medium text-fg-secondary mb-1">Recipients (one per line)</label>
        <textarea v-model="form.recipients" rows="5" class="w-full px-3 py-2 border border-border rounded-lg text-sm font-mono focus:ring-2 focus:ring-blue-500 outline-none" placeholder="user1@gmail.com&#10;user2@hotmail.com"></textarea>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div>
          <label class="block text-sm font-medium text-fg-secondary mb-1">Number of Emails</label>
          <input v-model.number="form.numberOfEmails" type="number" class="w-full px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
        </div>
        <div>
          <label class="block text-sm font-medium text-fg-secondary mb-1">Period Value</label>
          <input v-model.number="form.emailsPeriodValue" type="number" class="w-full px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
        </div>
        <div>
          <label class="block text-sm font-medium text-fg-secondary mb-1">Period Type</label>
          <select v-model="form.emailsPeriodType" class="w-full px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none">
