...
const actions = [
  { label: 'Edit', class: 'bg-primary-light text-primary hover:bg-blue-200', handler: (row) => router.push(`/gmail-accounts/${row.id}/edit`) },
...
<template>
  <div>
    <PageHeader title="Gmail Accounts" action-label="Add New Account" action-to="/gmail-accounts/add" />
