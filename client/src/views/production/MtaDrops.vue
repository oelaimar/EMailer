...
import { getMtaDrops, executeProcessAction } from '../../api/production';
...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-800">MTA Drops</h1>
    ...
    <DataTable
      ref="tableRef"
      :columns="columns"
      :fetch-data="async (params) => (await getMtaDrops(params)).data"
      :selectable="true"
      :actions="actions"
    >
