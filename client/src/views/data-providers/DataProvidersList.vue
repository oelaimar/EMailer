...
const actions = [
  { label: 'Edit', class: 'bg-primary-light text-primary hover:bg-blue-200', handler: (row) => router.push(`/data-providers/${row.id}/edit`) },
...
<template>
  <div>
    <PageHeader title="Data Providers" action-label="Add New Provider" action-to="/data-providers/add" />
