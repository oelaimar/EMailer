...
const actions = [
  { label: 'Edit', class: 'bg-primary-light text-primary hover:bg-blue-200', handler: (row) => router.push(`/verticals/${row.id}/edit`) },
...
<template>
  <div>
    <PageHeader title="Verticals" action-label="Add New Vertical" action-to="/verticals/add" />
