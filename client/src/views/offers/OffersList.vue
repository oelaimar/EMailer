...
const actions = [
  { label: 'Edit', class: 'bg-blue-100 text-blue-700 hover:bg-blue-200', handler: (row) => router.push(`/offers/${row.id}/edit`) },
...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      ...
      <router-link to="/offers/add" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors">
        + Add New Offer
      </router-link>
    </div>
