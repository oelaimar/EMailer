...
const actions = [
  { label: 'Edit', class: 'bg-primary-light text-primary hover:bg-blue-200', handler: (row) => router.push(`/management-servers/${row.id}/edit`) },
...
<template>
  <div>
    <PageHeader title="Management Servers" action-label="Add New Server" action-to="/management-servers/add" />
