...
const actions = [
  { label: 'Edit', class: 'bg-primary-light text-primary hover:bg-blue-200', handler: (row) => router.push(`/headers/${row.id}/edit`) },
...
<template>
  <div>
    <PageHeader title="Headers" action-label="Add New Header" action-to="/headers/add" />
