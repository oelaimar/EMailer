...
const actions = [
  { label: 'Edit', class: 'bg-primary-light text-primary hover:bg-blue-200', handler: (row) => router.push(`/affiliate-networks/${row.id}/edit`) },
...
<template>
  <div>
    <PageHeader title="Affiliate Networks" action-label="Add New Network" action-to="/affiliate-networks/add" />
