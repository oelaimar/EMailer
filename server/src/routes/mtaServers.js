...
router.post('/multi-add', auth, roleCheck('mta-servers', 'write'), controller.bulkAdd);
...
router.post('/:id/server-info', auth, roleCheck('mta-install', 'read'), controller.getServerInfo);
...
router.post('/:id/configure-additional-ips', auth, roleCheck('mta-ips', 'write'), controller.configureAdditionalIps);
...
router.post('/execute-command', auth, roleCheck('mta-servers', 'write'), controller.executeServersCommand);
